class Api::V1::UsersController < ApplicationController
  ...
  def update
      ...
      if @user.valid?
        @synth_setting = SynthSetting.create(gain: user_params[:synth_settings_attributes][:gain], reverb_wet: user_params[:synth_settings_attributes][:reverb_wet], reverb_decay: user_params[:synth_settings_attributes][:reverb_decay])
